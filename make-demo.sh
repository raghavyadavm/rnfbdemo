...
npm_config_yes=true npx react-native init rnfbdemo --skip-install --version=0.69.0-rc.2
cd rnfbdemo
...
echo "project.ext{set('react-native',[versions:[firebase:[bom:'30.0.1'],],])}" >> android/build.gradle
